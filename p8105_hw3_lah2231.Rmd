...
I filtered out all the July 24 data. Then I grouped by start stations, found the total rides, arranged them and took the top 5. The top stations were `r top_stations`.
...
ggplot(data_2024, aes(x = rideable_type, y = duration, fill = member_casual)) +
  ...
  theme_minimal()
```
I made a barplot to compare the 
